...
import 'package:cool_shop/login_screens/login_screen_navbar.dart';
...
class BodySwitcher extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      //! old value padding: const EdgeInsets.fromLTRB(14, 106, 14, 0),
        ...
        children: [
          Row(
            ...
            children: [
              ...
              const Spacer(flex: 2),
              GestureDetector(
                onTap: () => callback(PageTypes.login.index),
                child: Container(
                  padding: const EdgeInsets.only(bottom: 10),
                  decoration: BoxDecoration(
                    border: Border(
